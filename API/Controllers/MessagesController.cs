...
namespace API.Controllers
{
    ...
    public class MessagesController : BaseApiController
    {
        ...
        public MessagesController(IUserRepository userRepository, IMessageRepository mesageRepository, IMapper mapper)
        {
            _mapper = mapper;
        ...
        public async Task<ActionResult> DeleteMessage(int id)
        {
            ...
            if(message.SenderDeleted && message.RecipientDeleted) _mesageRepository.DeleteMessage(message);
